...
class TrojanMap {
 private:
  bool hasCycle(std::string current_id, std::map<std::string, bool> &visited,
                std::string parent_id, std::vector<double> &square, std::vector<std::string> &path);

  void TravellingTrojanAux(std::vector<std::string> &location_ids, std::vector<std::string> cur_path,
                            std::string cur_node, double cur_cost, double &min_cost,
                            std::pair<double, std::vector<std::vector<std::string>>> &results);

  void TravellingTrojanBruteForceAux(std::vector<std::string> &location_ids, std::vector<std::string> cur_path,
                            std::string cur_node, double cur_cost, double &min_cost,
                            std::pair<double, std::vector<std::vector<std::string>>> &results);

  void DeliveringTrojanAux(std::string cur_node, std::map<std::string, int> &marks,
